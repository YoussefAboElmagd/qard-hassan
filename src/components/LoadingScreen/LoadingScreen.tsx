...
export default function LoadingScreen() {
    return (
        <div className='fixed inset-0 z-50 grid place-items-center'>
            <div className='flex flex-col items-center gap-6 rounded-2xl bg-white/20 p-8 shadow-2xl backdrop-blur-md dark:bg-gray-900/95 border border-gray-200/50 dark:border-gray-700/50' role='status' aria-live='polite'>
